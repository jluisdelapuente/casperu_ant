...
<form method="post" action="upshotsecre_grl_serdoc.php">
  <p>&nbsp;</p>
	  <p>&nbsp;</p>
  <table width="612" border="0">
	    <tr>
	      <td colspan="5"><div align="center"><B>BUSQUEDA POR SERIE DOCUMENTAL</B></div></td>
    </tr>
	    <tr>
	      <td width="172"><strong>Ingrese la SERIE DOCUMENTAL: </strong></td>
...
Ejemplo: si se coloca ADS, El resultado sera de todos los ads, de los años ingresados (2008, 2009, 2010, etc.)
</form>
</body>
</html>