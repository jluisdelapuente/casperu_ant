...
if ( !isset($_POST['buscar']) ){
  echo "Debe indicar la REFERENCIA a buscar";
  echo "<p><a href=\"pursuesecre_grl_referen.php\">Volver</p> \n";
  exit;
}
?>
</p>
...
$query = "SELECT Id, Area, NrDoc, Seriedocumental, Fecha, Asunto, Referencia, Destino, DestinoPersona, INDICATIVO, DEPENDENCIA, OBSERVACIONES, Anio, Tomo, Folios, PDF, Extra1 FROM  table_sg WHERE Referencia
    LIKE '%".$_POST['buscar']."%' ORDER BY Referencia";

$result = mysql_query($query, $link)
        or die('Error en el SQL: ' . mysql_error($link));
echo "<a href='pursuesecre_grl_referen.php'>Regresar</a></td></tr>";
...
echo '</tr>';
  ...
  echo "<tr><td colspan='2'><a href='pursuesecre_grl_referen.php'>Regresar</a></td></tr>";
} else {
