...
if ( !isset($_POST['buscar']) ){
  ...
  echo "<p><a href=\"pursuelogist_nro.php\">Volver</p> \n";
  exit;
}
?>
</p>
<p>&nbsp; </p>
<div align='center'><strong><font size='4' face='Verdana, Arial, Helvetica, sans-serif'>Resultado de la Busqueda de Registros: -NRO DOCUMENTO-</font></strong>
...
$query = "SELECT id, Norden, SerieDoc, Concepto, Proveedor, NExpSIAF, Fecha, FecOtoBPro, Monto, TipoProceso, Ncontrato, Convocatoria, Objeto, Ncaja, Nexpediente, CntFolios, Anio, PDF, OBSERVACIONES FROM  tabla_amc WHERE Norden
    LIKE '%".$_POST['buscar']."%' ORDER BY Norden";
...
echo '</tr>';
  ...
  echo "<tr><td colspan='2'><a href='pursuelogist_nro.php'>Regresar</a></td></tr>";
} else {
echo "<tr><td colspan='2'>No hay registro.";
echo "<a href='pursuelogist_nro.php'>Regresar</a></td></tr>";
}
?>
</table>
</body>
