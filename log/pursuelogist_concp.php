...
<form method="post" action="upshotlogist_concp.php">
  <p>&nbsp;</p>
	  <p>&nbsp;</p>
  <table width="612" border="0">
	    <tr>
	      <td colspan="5"><div align="center"><B>BUSQUEDA POR CONCEPTO</B></div></td>
    </tr>
	    <tr>
	      <td width="172"><strong>Ingrese Concepto: </strong></td>
...
Para realizar la busqueda por CONCEPTO: <BR>
Se tiene que ingresar el concepto, el cual puede ser una exprecion exacta o una sola palabra.<br>
<br>
Ejemplo:
<br>
Se recomienda que sea una expresión exacta Ejemplo: "ADQUISICION DE SERVIDORES PARA EL MINAM " El sistema 
buscara la expresión exacta, si solo coloca una de la palabras ejemplo: “ADQUISICION” el sistema buscara 
en toda la base todos los registro que contengan 
la palabra “ADQUISICION” y la búsqueda será de mayor registros
